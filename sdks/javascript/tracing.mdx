...
<Tip>
  **Full examples**: [customer-support-agent](https://github.com/getfoil/foil-examples/tree/main/customer-support-agent) (native SDK tracing with tools) | [rag-agent](https://github.com/getfoil/foil-examples/tree/main/rag-agent) (retriever spans and LLM synthesis)
</Tip>
